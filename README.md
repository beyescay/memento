...
Also, typically the initial stability value is `s = 0.87`. So we use this to obtain the new stability and use the same equation to get future stability value after every repitition.

So, when we learn a new information the initial retention curve would look like this,
```
r = e^(-t/0.87)
```
...
After the fourth repitition, this is how long it would take for an information to completely vanish from the memory.
